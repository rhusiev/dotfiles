...
complete -c nvme-connect-all -l nbft -d 'Only look at NBFT tables'
complete -c nvme-connect-all -l no-nbft -d 'Do not look at NBFT tables'
complete -c nvme-connect-all -l nbft-path -d 'Use a user-defined path to the NBFT tables'
complete -c nvme-connect-all -l context -d 'Set the execution context to <STR>'
