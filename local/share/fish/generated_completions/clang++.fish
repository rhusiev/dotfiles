...
complete -c clang++ -o fmsc-version -d 'Set _MSC_VER'
...
complete -c clang++ -o fexceptions -d 'Allow exceptions to be thrown through Clang compiled stack frames (on many ta…'
...
complete -c clang++ -o nobuiltininc -d 'Do not search clang\'s builtin directory for include files'
