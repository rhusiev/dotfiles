...
complete -c systemctl -l firmware-setup -d 'When used with the reboot, poweroff, or halt command, indicate to the system\\…'
complete -c systemctl -l boot-loader-menu -d 'When used with the reboot, poweroff, or halt command, indicate to the system\\…'
complete -c systemctl -l boot-loader-entry -d 'When used with the reboot, poweroff, or halt command, indicate to the system\\…'
