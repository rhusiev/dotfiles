...
complete -c wvunpack -l aif -l aif-le -d 'force output to Apple AIFF (or AIFF-C/sowt), extension ". aif"'
...
complete -c wvunpack -l caf-be -l caf-le -d 'force output to big-endian or little-endian Core Audio, extension ". caf"'
complete -c wvunpack -s d -d 'delete source file if successful (use with caution!)'
complete -c wvunpack -l dff -l dsdiff -d 'force output to Philips DSDIFF, DSD audio source only, extension ". dff"'
...
complete -c wvunpack -s w -l wav -d 'force output to Microsoft RIFF/RF64, extension ". wav"'
