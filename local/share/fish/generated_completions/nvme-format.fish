...
complete -c nvme-format -s p -l pil -d 'Protection Information Location: If set to \'1\' and protection information is …'
complete -c nvme-format -s i -l pi -d 'Protection Information: This field specifies whether end-to-end data protecti…'
complete -c nvme-format -s m -l ms -d 'Metadata Settings: This field is set to \'1\' if the metadata is transferred as…'
