...
complete -c kexec -s c -l kexec-syscall -d 'Specify that the old KEXEC_LOAD syscall should be used exclusively'
...
complete -c kexec -l devicetreeblob -d 'Specify device tree blob file'
complete -c kexec -l dtb -d 'Specify device tree blob file'
...
complete -c kexec -l dt-no-old-root -d 'Do not reuse old kernel root=<device> param while creating flatten device tree'
