...
complete -c fpaste -s h -l help -d 'show this help message and exit'
complete -c fpaste -s t -l title -d 'title of paste; defaults to UNTITLED'
complete -c fpaste -s a -l author -d 'author name; empty by default'
complete -c fpaste -s r -l private -d 'make paste private; defaults to 1'
...
complete -c fpaste -s w -l wayland-clipin -d 'read paste text from Wayland selection [requires the wl-clipboard package]'
complete -c fpaste -s o -l clipout -d 'save returned paste URL to all available clipboards'
...
complete -c fpaste -l sysinfo -d 'paste system information'
...
complete -c fpaste -l confirm -d 'print paste, and prompt for confirmation before sending'
complete -c fpaste -l raw-url -d 'print raw url EXAMPLES'
