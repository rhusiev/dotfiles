...
complete -c pip-install -l no-deps -d 'Don\'t install package dependencies'
...
complete -c pip-install -l dry-run -d 'Don\'t actually install anything, just print what would be'
...
complete -c pip-install -l abi -d 'Only use wheels compatible with Python abi <abi>, e. g.  \'pypy_41\''
...
complete -c pip-install -l no-clean -d 'Don\'t clean up build directories'
