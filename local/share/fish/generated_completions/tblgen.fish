...
complete -c tblgen -o gen-clang-attr-classes -d 'Generate Clang attribute classes'
...
complete -c tblgen -o gen-riscv-sifive-vector-builtins -d 'Generate riscv_sifive_vector_builtins. inc for Clang'
complete -c tblgen -o gen-riscv-sifive-vector-builtin-codegen -d 'Generate riscv_sifive_vector_builtin_cg. inc for Clang'
...
complete -c tblgen -o gen-global-isel-combiner -d '(Deprecated, pending removal) Generate legacy GlobalISel combiner'
complete -c tblgen -o gen-global-isel-combiner-matchtable -d 'Generate MatchTable-based GlobalISel combiner'
complete -c tblgen -o combiners -d 'Make -gen-global-isel-combiner and -gen-global-isel-combiner-matchtable emit …'
...
complete -c tblgen -o gicombiner-stop-after-parse -d 'Make -gen-global-isel-combiner and -gen-global-isel-combiner-matchtable stop …'
