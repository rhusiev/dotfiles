...
complete -c git-format-patch -l description-file -d 'Use the contents of <file> instead of the branch\'s description for generating…'
...
complete -c git-format-patch -l rfc -d 'Prepends "RFC" to the subject prefix (producing "RFC PATCH" by default)'
...
complete -c git-format-patch -l stat-graph-width -d 'or by setting diff. statGraphWidth=<width>.  Using'
